<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户编号" prop="user_id" width="100" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item v-if="form.action === 'edit-pwd'" label="原密码" prop="old_password" required>
          <el-input v-model="form.old_password" type="password" placeholder="请输入原用户密码" />
        </el-form-item>
        <el-form-item v-if="!form.user_id || form.action === 'edit-pwd'" label="用户密码" prop="password" required>
          <el-input v-model="form.password" type="password" placeholder="请输入用户密码" />
        </el-form-item>
        <el-form-item v-if="!form.user_id || form.action === 'edit-pwd'" label="确认密码" prop="repassword" required>
